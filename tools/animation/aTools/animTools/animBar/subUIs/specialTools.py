...
from BM2Public.tools.animation.aTools.commonMods import uiMod;   reload(uiMod)
...
for loopMod in MODULES:
    exec("from BM2Public.tools.animation.aTools.animTools.animBar.subUIs.specialTools_subUIs import %s; reload(%s)"%(loopMod, loopMod))
