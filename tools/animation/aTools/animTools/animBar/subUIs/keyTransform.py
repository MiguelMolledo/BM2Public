...
from BM2Public.tools.animation.aTools.animTools.animBar.subUIs import tangents;   reload(tangents)
from BM2Public.tools.animation.aTools.animTools.animBar.subUIs.specialTools_subUIs import mirror;   reload(mirror)
