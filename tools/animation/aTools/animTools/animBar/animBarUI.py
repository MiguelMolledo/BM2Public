...
from BM2Public.tools.animation.aTools.generalTools        import aToolsClasses;               reload(aToolsClasses)
from BM2Public.tools.animation.aTools.commonMods          import animMod;                     reload(animMod)
from BM2Public.tools.animation.aTools.generalTools        import generalToolsUI;              reload(generalToolsUI)
from BM2Public.tools.animation.aTools.commonMods          import utilMod;                     reload(utilMod)
from BM2Public.tools.animation.aTools.commonMods          import commandsMod;                 reload(commandsMod)
from BM2Public.tools.animation.aTools.commonMods          import aToolsMod;                   reload(aToolsMod)
from BM2Public.tools.animation.aTools                     import setup;                       reload(setup)
...
for loopMod in SUB_UI_MODS:
    exec("import BM2Public.tools.animation.aTools.animTools.animBar.subUIs.%s as %s; reload(%s)"%(loopMod, loopMod, loopMod))
