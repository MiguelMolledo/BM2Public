...
G.USER_FOLDER       = G.USER_FOLDER or r'P:\TOOLS\BM2Public\tools\animation\aTools' + os.sep + "aToolsSettings"
...
def deleteFolderWithUser(folder):
    folderPath = "%s%s%s"%(r'P:\TOOLS\BM2Public\tools\animation\aTools', os.sep, folder)
...
def renameFolderWithUser(oldFolder, newFolder):
    oldUserFolder = "%s%s%s"%(r'P:\TOOLS\BM2Public\tools\animation\aTools', os.sep, oldFolder)
    newUserFolder = "%s%s%s"%(r'P:\TOOLS\BM2Public\tools\animation\aTools', os.sep, newFolder)
...
def getSaveFilePath(saveFile, ext="aTools"):
    ...
    saveFilePath = r'P:\TOOLS\BM2Public\tools\animation\aTools' + os.sep + saveFile
